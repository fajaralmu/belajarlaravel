...
class EntityElement
{
    ...
    private function init()
    {
        ...
        $this->hasJoinColumn = $this
            ->formField->foreignKey != "" && $this
            ->formField->foreignKey != null;
    ...
    private function doBuild()
    {
        ...
        $hasJoinColumn = $this
            ->formField->foreignKey != null && $this
            ->formField->foreignKey != "";
        //FIXME
    ...
    private function checkDetailField()
    {
        ...
        if (!is_null($this
            ->formField
            ->detailFields) && sizeof($this
            ->formField
            ->detailFields) > 0)
        {
            $this->detailFields = join("~", $this
                ->formField
                ->detailFields);
        }
        if ($this
    ...
    {
        array_push($this
            ->entityProperty->multipleSelectElements, $this
            ->field
            ->getName());
    }
    ...
    {
        array_push($this
            ->entityProperty->currencyElements, $this
            ->field
            ->getName());
    }
    ...
    {
        array_push($this
            ->entityProperty->imageElements, $this
            ->field
            ->getName());
    }
    ...
    {
        array_push($this
            ->entityProperty->dateElements, $this
            ->field
            ->getName());
    }
    ...
    {
        out("field {} of {} is join column, type: {}", $this
            ->field
            ->getName() , $this
            ->field
            ->getDeclaringClass() , $fieldType);
        $referenceEntityClass = new ReflectionType();
        $referenceEntityClass = $this
            ->field
            ->getType();
        ...
        // }
        if ($fieldType == "FIELD_TYPE_FIXED_LIST" && $this->additionalMap != null && array_has($this->additionalMap, $this
            ->field
            ->getName()))
        {

            $referenceEntityList = $this->additionalMap[$this
                ->field
                ->getName() ];
            ...
            out("Additional map with key: {} -> Length: {}", $this
                ->field
                ->getName() , sizeof($referenceEntityList));
        ...
        $this->foreignKey = $this
            ->formField->foreignKey;
        $this->multipleSelect = ($this
            ->formField
            ->multipleSelect);
        $this->optionItemName = ($this
            ->formField
